    ...
    public function run(): void
    {
        ...
        DB::table('directories.animals_breeds')->insert([
            [
                ...
                "breed_name" => "Битал",
                "breed_selex_code" => null,
                "breed_status" => "enabled",
                "breed_status_delete" => "active",
                "created_at" => "2024-11-01 12:28:44",
        ...
        DB::statement("SELECT setval('directories.animals_breeds_breed_id_seq', (SELECT MAX(breed_id) from directories.animals_breeds))");
    }
}
