...
return [
    ...
    'countries_regions_districts' => [
        'title'                  => 'Районы',
        'description'            => 'Импортированные районы из справочников SELEX',
        'edit'                   => 'Редактирование района',
        'create'                 => 'Создание района',
    ...
    'countries_regions'           => [
        'title'                => 'Области',
        'description'          => 'Импортированные Области из справочников SELEX',
        'edit'                 => 'Редактирование области',
        'create'               => 'Создание области',
        'region_id'            => 'Инкремент',
        'region_obl'           => 'Внешний код региона',
        'country_id'           => 'Внутренний код страны',
    ...
    'countries'                   => [
        'title'                 => 'Страны',
        'description'           => 'Импортированные Страны из справочников SELEX',
