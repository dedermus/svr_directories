...
class DirectoryMarkTypes extends Model
{
     ...
     * @return array
     */
    public static function markTypesList($per_page, $cur_page, $search_data): array
    {
        $where_array = [['mark_type_status', '=', SystemStatusEnum::ENABLED->value], ['mark_type_status_delete', '=', SystemStatusDeleteEnum::ACTIVE->value]];

        if (isset($search_data['mark_type_name'])) $where_array[] = ['mark_type_name', 'ilike', '%'.$search_data['mark_type_name'].'%'];
