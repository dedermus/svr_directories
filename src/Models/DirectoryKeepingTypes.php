...
class DirectoryKeepingTypes extends Model
{
     ...
     * @return array
     */
    public static function keepingTypesList($per_page, $cur_page, $search_data): array
    {
        $where_array = [['keeping_type_status', '=', SystemStatusEnum::ENABLED->value], ['keeping_type_status_delete', '=', SystemStatusDeleteEnum::ACTIVE->value]];

        if (isset($search_data['keeping_type_name'])) $where_array[] = ['keeping_type_name', 'ilike', '%'.$search_data['keeping_type_name'].'%'];
